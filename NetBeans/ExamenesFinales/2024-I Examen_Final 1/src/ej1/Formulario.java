...
public class Formulario extends javax.swing.JFrame {
            ...
            case 2:
                ...
                switch (t) {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        Herramientas.mensaje("OPCION INCORRECTA");
                }
                break;
            default:
                Herramientas.mensaje("OPCION INCORRECTA");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        switch (D) {
            case 1:
                do {
                    codigo = Herramientas.generarAleatorio(1000, 1199);
                } while (codigoRepetido(codigo));
                nombre = Herramientas.ingreso("INGRESE NOMBRE Y APELLIDO").toUpperCase();
                sexo = Herramientas.ingreso("INGRESE SEXO").toUpperCase();
                edad = Integer.parseInt(Herramientas.ingreso("INGRESE EDAD"));
                if (edad >= 18) {
                    ...
                    switch (t) {
                        ...
                        case "ARQUITECTURA":
                            carrera = t;
                            int creditos = Integer.parseInt(Herramientas.ingreso("INGRESAR CANTIDAD DE CREDITOS"));
                            Alumno A = new Alumno(codigo, nombre, sexo, edad, carrera, creditos);
                            vec[indice] = A;
                            A.Mostrar();
                            indice++;
                            break;
                    ...
                    Herramientas.mensaje("NO SE PUEDEN REGISTRAR ALUMNOS MENORES DE 18");
                }
                break;
            case 2:
                ...
                switch (tipo) {
                    case 1:
                        do {
                            codigo = Herramientas.generarAleatorio(1200, 1299);
                        } while (codigoRepetido(codigo));
                        nombre = Herramientas.ingreso("INGRESE NOMBRE Y APELLIDO").toUpperCase();
                        sexo = Herramientas.ingreso("INGRESE SEXO").toUpperCase();
                        edad = Integer.parseInt(Herramientas.ingreso("INGRESE EDAD"));
                        if (edad >= 18) {
                            int horas = Integer.parseInt(Herramientas.ingreso("INGRESE HORAS:"));
                            if (horas == 40) {
                                String gradoAcademico = Herramientas.ingreso("ESCRIBA GRADO ACADEMICO:\nBACHILLER\nMAGISTER\nDOCTOR").toUpperCase();
                                if (gradoAcademico.equals("BACHILLER") || gradoAcademico.equals("MAGISTER") || gradoAcademico.equals("DOCTOR")) {
                                    String periodo = Herramientas.ingreso("PERIODO DE CONTRATO:\nANUAL\nSEMESTRAL").toUpperCase();
                                    if (periodo.equals("ANUAL") || periodo.equals("SEMESTRAL")) {
                                        Docente_TC Dtc = new Docente_TC(codigo, nombre, sexo, edad, horas, gradoAcademico, periodo);
                                        vec[indice] = Dtc;
                                        Dtc.Mostrar();
                                        indice++;
                                    } else {
                                ...
                                Herramientas.mensaje("DE TIEMPO COMPLETO DEBE SER 40 HORAS");
                            }
                        } else {
                            Herramientas.mensaje("NO SE PUEDEN REGISTRAR PERSONAS MENORES DE EDAD");
                        }
                        break;
                    case 2:
                        do {
                            codigo = Herramientas.generarAleatorio(1300, 1399);
                        } while (codigoRepetido(codigo));
                        nombre = Herramientas.ingreso("INGRESE NOMBRE Y APELLIDO").toUpperCase();
                        sexo = Herramientas.ingreso("INGRESE SEXO").toUpperCase();
                        edad = Integer.parseInt(Herramientas.ingreso("INGRESE EDAD"));
                        if (edad >= 18) {
                            int horas = Herramientas.generarAleatorio(1, 39);
                            String grado = Herramientas.ingreso("ESCRIBA GRADO ACADEMICO\nBACHILLER\nMAGISTER\nDOCTOR").toUpperCase();
                            if (grado.equals("BACHILLER") || grado.equals("MAGISTER") || grado.equals("DOCTOR")) {
                                String uA = Herramientas.ingreso("INGRESE UNIDAD ACADEMICA:").toUpperCase();
                                Docente_TP Dtp = new Docente_TP(codigo, nombre, sexo, edad, horas, grado, uA);
                                vec[indice] = Dtp;
                                Dtp.Mostrar();;
                                indice++;
                            } else {
                        ...
                        break;
                    default:
                        Herramientas.mensaje("LA RESPUESTA NO ES CORRECTA");
                }
                break;
            default:
                Herramientas.mensaje("RESPUESTA INCORRECTA");
        }
